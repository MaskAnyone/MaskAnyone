...
class BaseDetector:
    ...
    def detect_part(
        self, frame: np.ndarray, part_name: str, type: DetectionType, timestamp_ms: int
    ) -> np.ndarray:
        if type == "silhouette":
