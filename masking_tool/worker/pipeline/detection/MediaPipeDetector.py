...
class  MediaPipeDetector(BaseDetector):
    ...
    def detect_body_silhouette(self, frame: np.ndarray, timestamp_ms: int) -> np.ndarray:
    ...
    def detect_boundingbox(self, frame, part_name: str):
        raise NotImplementedError("Bounding Box detection is not specified for MediaPipe Detector")