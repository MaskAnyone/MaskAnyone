        ...
        while True:
            ...
            if pose_landmarker_result.segmentation_masks:
                for segmentation_mask in pose_landmarker_result.segmentation_masks:
                    ...
                    output_image[mask > 0.1] = [0, 0, 128]
                    output_image[mask <= 0.1] = 0
...
if __name__ == "__main__":
    video_path = "ted-kid_432_240_short.mp4"  # Path to your input video file
    output_folder = "ted-kid_432_240_short_masked"  # Path to the output folder
