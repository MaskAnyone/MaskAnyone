...
MODELS = [
    # Human pose — RTMPose (COCO). Only these are pre-downloaded; animal models
    # are marked "in development" in the UI and will be pulled on first request
    # (or enabled here) once they've been tested and tuned.
    'rtmpose-s_8xb256-420e_coco-256x192',
    'rtmpose-m_8xb256-420e_coco-256x192',
    'rtmpose-l_8xb256-420e_coco-256x192',
]

# Animal pose variants — not downloaded by default. Re-add to MODELS above when ready:
