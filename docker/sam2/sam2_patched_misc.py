# This is a patched version of the file taken from https://raw.githubusercontent.com/facebookresearch/sam2/refs/heads/main/sam2/utils/misc.py
# Patched parts are annotated with "PATCHED: "
...
def load_video_frames(
    ...
    if is_bytes or is_mp4_path:
        return load_video_frames_from_video_file(
            ...
            img_mean=img_mean,
            img_std=img_std,
            async_loading_frames=async_loading_frames, # PATCHED: Pass to method
...
def load_video_frames_from_video_file(
    ...
    img_mean=(0.485, 0.456, 0.406),
    img_std=(0.229, 0.224, 0.225),
    async_loading_frames=False,  # PATCHED: Take as argument
    compute_device=torch.device("cuda"),
):
    ...
    # PATCHED: async loader
    if async_loading_frames:
        lazy_images = SequentialAsyncVideoLoader(
            video_path=video_path,
            image_size=image_size,
            img_mean=img_mean,
            img_std=img_std,
