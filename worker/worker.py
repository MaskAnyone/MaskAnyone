...
WORKER_RTMPOSE_BASE_PATH = 'http://rtmpose:8000/rtmpose'
...
def main():
    ...
    rtmpose_client = RtmposeClient(WORKER_RTMPOSE_BASE_PATH)
    ...
    try:
        worker_process = WorkerProcess(backend_client, sam2_client, openpose_client, rtmpose_client, video_manager)
        worker_process.run()
